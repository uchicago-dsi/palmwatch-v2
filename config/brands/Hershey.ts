...
export const Hershey: BrandSchema = {
  name: "The Hershey Company",
  country: "United States",
  rspoMemberSince: "2011-04-21",
  externalLink:
  ...
  disclosures: [
    {
      ...
      filename: "disclosures/hershey/2020H1_hershey.pdf",
    },
    {
      year: '2020 (Second Half)',
      filename: "disclosures/hershey/2020H2_hershey.pdf",
    }
  ],
};
